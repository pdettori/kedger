...
func GetOpenAPIDefinitions(ref common.ReferenceCallback) map[string]common.OpenAPIDefinition {
	return map[string]common.OpenAPIDefinition{
		"github.com/pdettori/kedger/pkg/apis/registry/v1alpha1.Cluster":       schema_pkg_apis_registry_v1alpha1_Cluster(ref),
		"github.com/pdettori/kedger/pkg/apis/registry/v1alpha1.ClusterList":   schema_pkg_apis_registry_v1alpha1_ClusterList(ref),
		"github.com/pdettori/kedger/pkg/apis/registry/v1alpha1.ClusterSpec":   schema_pkg_apis_registry_v1alpha1_ClusterSpec(ref),
		"github.com/pdettori/kedger/pkg/apis/registry/v1alpha1.ClusterStatus": schema_pkg_apis_registry_v1alpha1_ClusterStatus(ref),
...
func schema_pkg_apis_registry_v1alpha1_Cluster(ref common.ReferenceCallback) common.OpenAPIDefinition {
	return common.OpenAPIDefinition{
			...
			SchemaProps: spec.SchemaProps{
				...
				Properties: map[string]spec.Schema{
					...
					"spec": {
						SchemaProps: spec.SchemaProps{
							Default: map[string]interface{}{},
							Ref:     ref("github.com/pdettori/kedger/pkg/apis/registry/v1alpha1.ClusterSpec"),
						},
					},
					"status": {
						SchemaProps: spec.SchemaProps{
							Default: map[string]interface{}{},
							Ref:     ref("github.com/pdettori/kedger/pkg/apis/registry/v1alpha1.ClusterStatus"),
						},
					},
				},
			},
		...
		Dependencies: []string{
			"github.com/pdettori/kedger/pkg/apis/registry/v1alpha1.ClusterSpec", "github.com/pdettori/kedger/pkg/apis/registry/v1alpha1.ClusterStatus", "k8s.io/apimachinery/pkg/apis/meta/v1.ObjectMeta"},
	}
}

func schema_pkg_apis_registry_v1alpha1_ClusterList(ref common.ReferenceCallback) common.OpenAPIDefinition {
	return common.OpenAPIDefinition{
		Schema: spec.Schema{
			SchemaProps: spec.SchemaProps{
						...
						SchemaProps: spec.SchemaProps{
							...
							Items: &spec.SchemaOrArray{
								Schema: &spec.Schema{
									SchemaProps: spec.SchemaProps{
										Default: map[string]interface{}{},
										Ref:     ref("github.com/pdettori/kedger/pkg/apis/registry/v1alpha1.Cluster"),
									},
								},
							},
						},
		...
		Dependencies: []string{
			"github.com/pdettori/kedger/pkg/apis/registry/v1alpha1.Cluster", "k8s.io/apimachinery/pkg/apis/meta/v1.ListMeta"},
	}
}

func schema_pkg_apis_registry_v1alpha1_ClusterSpec(ref common.ReferenceCallback) common.OpenAPIDefinition {
	return common.OpenAPIDefinition{
		Schema: spec.Schema{
			SchemaProps: spec.SchemaProps{
...
func schema_pkg_apis_registry_v1alpha1_ClusterStatus(ref common.ReferenceCallback) common.OpenAPIDefinition {
	return common.OpenAPIDefinition{
		Schema: spec.Schema{
			SchemaProps: spec.SchemaProps{
